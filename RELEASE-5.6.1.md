...
- IM controls use Secure / Unsecure language.
- Chat controls use Secure Room / Unsecure Room language.
- Existing encryption methods, cipher/handshake/key derivation, secure-room cryptography, payload formats, and secure file-transfer cryptography are unchanged.

See `SECURE-UX-UPDATE.md` for implementation notes.
